...
function wc_customer_profile_pictures_get_user_active_picture_index( $customer_id = null ): int {
	...
	return wc_customer_profile_pictures()->get_account_settings_instance()->get_customer_active_profile_picture_index( $customer_id );
...
function wc_customer_profile_pictures_get_user_active_picture( $return = 'url', $customer_id = null ) {
	...
	return wc_customer_profile_pictures()->get_account_settings_instance()->get_customer_active_profile_picture( $return, $customer_id );
...
function wc_customer_profile_pictures_get_user_pictures( $customer_id = null ): array {
	...
	return wc_customer_profile_pictures()->get_account_settings_instance()->get_customer_profile_pictures( $customer_id );
